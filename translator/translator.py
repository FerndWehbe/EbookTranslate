...
class Translate:
    ...
    def _download_languages(self, lang: str):
        ...
        download_path = available_packages.download()  # type: ignore
    ...
    def _start_translate(self, source_lang: str, target_lang: str) -> None:
        ...
        self.translation: ITranslation = from_lang.get_translation(to_lang)  # type: ignore
